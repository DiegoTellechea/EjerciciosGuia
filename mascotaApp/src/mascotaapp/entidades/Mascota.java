...
public class Mascota {
    ...
    public String apodo;
    public String tipo; // Conejo, gato, perro, loro, hamster
    public String color;
    public int edad;
    public boolean cola;
    public String raza;
    ...
    public Mascota( String nombre, String apodo, String tipo){
        this.nombre = nombre;
        this.apodo = apodo;
        if (tipo.equals("Perro") || tipo.equals("Gato") || tipo.equals("Loro") || tipo.equals("Hamster"))
        this.tipo = tipo;
        this.energia = 1000;
    } 
